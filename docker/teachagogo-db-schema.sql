...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `is_zombie` INT NULL,
  `donations_options_id` INT NULL,
  `num_donation_option_prompts` INT NULL,
  `num_donation_prompts_total` INT NULL,
  ...
  `updated_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  INDEX `fk_users_donations_options1_idx` (`donations_options_id` ASC),
