...
module.exports.UserDonationOption       = require(__dirname + '/userDonationOption')(sequelize);
module.exports.UserPermission           = require(__dirname + '/userPermission')(sequelize);
...
module.exports.ResourcePreview          = require(__dirname + '/resourcePreview')(sequelize);
module.exports.ResourceFile             = require(__dirname + '/resourceFile')(sequelize);
...
module.exports.SupportThreadMessage     = require(__dirname + '/supportThreadMessage')(sequelize);
